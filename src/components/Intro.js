...
function Intro() {
  return (
    <div className="container">
      ...
      <h2>How to Play:</h2>
      <p>
        The object of the game is to beat your opponent by getting a count as
      ...
      <ol>
        <li>
          At the start of the game, each player is dealt 2 random cards from the
          deck.
        </li>
        <li>
          ...
          If you stand, your opponent executes their turn and whoever is closest
